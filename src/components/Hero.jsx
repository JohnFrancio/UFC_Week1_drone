    ...
    <div className='overflow-hidden'>
      <div className="grid grid-cols-2">
        <div className='text-white my-20'>
          <div className='flex flex-col gap-3 font-bold text-7xl'>
            <h1>The Best View</h1>
            <h1>In The World</h1>
          ...
          <div className="flex gap-8 font-semibold">
            ...
            <button className='flex items-center gap-3 text-center transition cursor-default duration-500 hover:-translate-y-1'>
